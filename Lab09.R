...
TIC05 = CNmodel(CNmodeldf = TIC05, CNavg=VSAsol$CN[5], 
                declat=declat,declon=declon)
# TIC05 is closest to the stream, you can tell bc it has the highest CN
...
plot(DPTI05$date,DPTI05$DF,type="l")

# tau is the calibration parameter to control how fast it decreases
...
plot(DPLT$date,DPLT$LT, type="l",ylim=c(1,15),xlab="Date",ylab="DP load (kg/d)")
